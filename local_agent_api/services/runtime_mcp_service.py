...
from local_agent_api.runtime.mcp_config import load_mcp_config, resolve_project_mcp_json
from local_agent_api.runtime.tool_registry import get_mcp_status, initialize_runtime_tools
...
def _mcp_path() -> Path:
    ...
    return Path(settings.WORKSPACE_ROOT) / ".mcp.json"
